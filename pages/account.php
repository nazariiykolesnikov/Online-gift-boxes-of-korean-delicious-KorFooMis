    ...
    <main>
        ...
        <section class="account my-5 py-5">
            <div class="row container mx-auto">
                <div class="text-center mt-3 pt-5 col-lg-6 col-md-12 col-sm-12">
                    <h3 class="form-weight-bold">Інформація про Ваш профіль</h3>
                    <hr class="mx-auto" />
                    <div class="account-info">
                        <p>Ім'я: <span>Борис Джонсонюк</span></p>
                        <p>Електронна скринька: <span>borisjohnsonuk34@gmail.com</span></p>
                        <p><a href="#" id="order-btn">Ваші замовлення:</a></p>
                        <p><a href="#" id="logout-btn">Вийти з аккаунту</a></p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <form id="account-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="account-password" placeholder="Введіть пароль" />
                        </div>
                        <div class="form-group">
                            <label>Повторити пароль</label>
                            <input type="password" class="form-control" id="account-confirm-password" placeholder="Введіть пароль ще раз" />
                        </div>
                        <div class="form-group">
                            <input type="submit" class="btn" id="change-password-btn" placeholder="Підтвердити" />
                        </div>
                    </form>
                </div>
            </div>
        ...
        <section class="orders container my-5 py-5">
            <div class="container mt-2">
                <h2 class="font-weight-bolder text-center">Твій Кошик</h2>
                <hr class="mx-auto" />
            </div>
                ...
                <tr>
                    <td>
                        <div class="product-info">
                            <img src="../assets/images/featured/featured_10.jpg" alt="Product Image" />
                            <div>
                                <p class="mt-3">Напій газований</p>
                            </div>
                        </div>
                    </td>
                    <td>
                        <span>2026-01-01</span></spam>
                    </td>
                </tr>
            </table>
            ...
            <div class="checkout-container">
                <button class="btn checkout-btn">Перевірити</button>
            </div>
        </section>
    </main>
