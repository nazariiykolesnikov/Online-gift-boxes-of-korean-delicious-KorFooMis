...
<body>
    ...
    <main>
        <section id="task-table__section" class="container my-5 py-5">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped align-middle text-center shadow">
                        <thead class="table-dark">
                            <tr>
                                <th class="task-table__header-cell">№<br /> п/п</th>
                                <th class="task-table__header-cell">Завдання</th>
                                <th class="task-table__header-cell">Винагорода</th>
                                <th class="task-table__header-cell">Опис</th>
                                <th class="task-table__header-cell">Категорія</th>
                                <th class="task-table__header-cell">Посилання</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="task-table__row">
                                ...
                                <td class="task-table__cell">
                                    Намалювати будь-який малюнок для військового та відправити фото через месенджер.
                                </td>
                                <td class="task-table__cell">
                                    50 балів на рахунок
                                </td>
                                <td class="task-table__cell">
                                   Потрібно обрати кому з військових Ви хочете відправити малюнок (малюнки), намалювати будь-який малюнок (малюнки) на Вашу фантазію та розсуд, потім написати військовому (військовим) в месенджері та відправити фотографію цього малюнку йому (їм).
                                </td>
                                <td class="task-table__cell">
                                    <span class="badge bg-info text-dark">Творчість</span></td>
                                <td class="task-table__cell">
                                    <a href="#" class="btn btn-outline-primary btn-sm">Виконати завдання</a>
                                </td>
                            </tr>
                            <tr class="task-table__row">
                                <td class="task-table__cell">
                                ...
                                <td class="task-table__cell">
                                    Написати будь-який коментар у соціальних мережах (Instagram, Facebook, Threads) в підтримку військового (військових) під постами військових.
                                </td>
                                <td class="task-table__cell">
                                    10 балів на рахунок
                                </td>
                                <td class="task-table__cell">
                                   Потрібно написати будь-який коментар у соціальних мережах (Instagram, Facebook, Threads) в підтримку військового (військових) під постами військових та відправити нам фото підтвердження.
                                </td>
                                <td class="task-table__cell">
                                    <span class="badge bg-info text-dark">Підтримка</span></td>
                                <td class="task-table__cell">
                                    <a href="#" class="btn btn-outline-primary btn-sm">Виконати завдання</a>
                                </td>
                            </tr>
                             <tr class="task-table__row">
                                ...
                                <td class="task-table__cell">
                                    Заспівати пісню (або куплет пісні), розповісти вірш чи (або уривок вірша чи твору українського або зарубіжного письменника), зтанцювати танець, зняти це на відео і відправити військовому (військовим)  
                                </td>
                                <td class="task-table__cell">
                                    від 20 до 200 балів на рахунок (в залежності від того, на скільки якісним є виступ)
                                </td>
                                <td class="task-table__cell">
                                    Заспівати пісню (або куплет пісні), розповісти вірш чи уривок з творів письменників, зтанцювати танець, зняти це на відео і відправити військовому (військовим) у соцмережаї - отримати бали                                </td>
                                <td class="task-table__cell">
                                    <span class="badge bg-info text-dark">Підтримка</span></td>
                                <td class="task-table__cell">
                                    <a href="#" class="btn btn-outline-primary btn-sm">Виконати завдання</a>
