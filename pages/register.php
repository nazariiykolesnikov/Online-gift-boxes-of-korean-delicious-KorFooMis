            ...
            <div class="mx-auto container">
                <form id="register-form">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="register-name" name="name" placeholder="Ім'я" required /> 
                    </div>
                    <div class="form-group">
                        <label>Електронна скринька (E-mail):</label>
                        <input type="password" class="form-control" id="register-email" name="email" placeholder="Електронна скринька" required /> 
                    </div>
                    <div class="form-group">
                        <label>Пароль</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="register-confirm-password" name="confirm-password" placeholder="Підтвердіть пароль" required /> 
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btn" id="register-btn" value="Зареєструватися" /> 
                    </div>
                    <div class="form-group">
                        <a id="register-url" class="btn">Уже маєте власний аккаунт ? Авторизуйтесь</a>   
                    </div>
                </form>
            </div>
        </section>
