...
<body>
    ...
    <main>
        <section id="featuted" class="my-5 py-5">
            <div class="container mt-5 py-5 text-center">
                <h3>Каталог товарів</h3>
                <hr class="mx-auto" />
                <p>В цьому розділи Ви знайдете увесь асортимент товарів, які Ви можете отримати проявивши активність та доклавши гарних зусиль. Бажаємо Вам успіхів !</p>
            </div>
